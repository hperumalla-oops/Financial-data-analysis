...
tokens = {'av_token': '6LJN56ZP8NCCDTHA',
    'iex_token': 'meh'}
...
# GCP project config
gcp_project_id = 'bigdatafinance-491008'

# Pub/Sub topics 
gcp_project_id = 'bigdatafinance-498705'

pubsub_topics = {
    'vix': 'projects/bigdatafinance-498705/topics/vix',
    'volume': 'projects/bigdatafinance-498705/topics/volume',
    'cot': 'projects/bigdatafinance-498705/topics/cot',
    'ind': 'projects/bigdatafinance-498705/topics/intraday',
    'deep': 'projects/bigdatafinance-498705/topics/deep',
    'predict_timestamp': 'projects/bigdatafinance-498705/topics/predict_timestamp',
    'prediction': 'projects/bigdatafinance-498705/topics/prediction'
}

# Database (Cloud SQL)

mysql_user = 'root'
mysql_password = 'Aiml@123'
mysql_hostname = '127.0.0.1'   
mysql_port = '3306'
mysql_database_name = 'finance_database'
